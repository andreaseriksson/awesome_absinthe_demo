defmodule AwesomeAbsintheDemo.Fixtures do
  alias AwesomeAbsintheDemo.Authentication
  alias AwesomeAbsintheDemo.Authentication.User
  alias AwesomeAbsintheDemo.Things
  alias AwesomeAbsintheDemo.Things.Thing
